    ...
    public void JogarTBBT() {
        ...
        switch (escolha) {
            ...
            case 3:
                ...
                break;
            case 4:
                j1 = new Jogador(nome, Jogada.LIZARD);
                break;
            case 5:
                j1 = new Jogador(nome, Jogada.SPOKE);
                break;
        }
        ...
        switch (escolha){
            ...
            case 3:
                ...
                break;
            case 4:
                j2 = new Jogador(nome, Jogada.LIZARD);
                break;
            case 5:
                j2 = new Jogador(nome, Jogada.SPOKE);
                break;
        }
        System.out.println("J1 - " + j1.Competicao(j2));
