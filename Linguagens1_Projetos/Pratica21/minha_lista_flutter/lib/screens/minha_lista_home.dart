...
class _MinhaListaHome3State extends State<MinhaListaHome3> {
  final _myHerosList = [MyHero("All Might", "One for All", "http://abridgedseries.com/wp-content/uploads/2018/08/310613.jpg"),
    ...
    MyHero("Baguko", "Explosão", "http://img.favpng.com/0/5/11/my-hero-academia-eijirou-kirishima-tenya-iida-character-boku-no-hero-academia-smash-png-favpng-3cwat4m5L3Ggp2ntKy51q3BJN.jpg"),
    MyHero("Ochako", "Zero Gravity", "http://i.pinimg.com/originals/2d/df/84/2ddf8471ddc8841a4b2ceeb3b5ca61ea.png"),
  ];
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
          body: Column(
            children: [
              SizedBox(width:200, height: 100,child: Image.network("http://upload.wikimedia.org/wikipedia/commons/c/cf/Boku_no_Hero_Academia_Logo.png")),
                ...
                child: ListView.builder(
                  itemBuilder: (context, index){
                    return ListTile(
                      ...
                      subtitle: Text(_myHerosList[index].singularidade),
                      leading: Image.network(_myHerosList[index].urlImg),
                    );
                  },
